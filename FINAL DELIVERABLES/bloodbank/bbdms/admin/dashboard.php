			...
			<div class="container-fluid">
				...
				<div class="row" >
					<div class="col-md-12" >
						...
						<h2 class="page-title" style="font-style:italic;" >Dashboard</h2>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light" style="background-color:orange ;">
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light" style="background-color:white ;">
												<div class="stat-panel text-center" style="color:#000080 ;">
												<?php 
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light" style="background-color:#32CD32 ;">
												<div class="stat-panel text-center">
												<?php 
