...
<div class="col-lg-6">
                <img class="img-fluid rounded" src="https://lo5.s3.jp-tok.cloud-object-storage.appdomain.cloud/covid-plasma-antibody-donation-web.jpg"  alt="" width="500" height="250" style="margin-left: 500px";>
            </div>
            <style>
        body {
            height: 100hv;
            background-image: linear-gradient(to bottom,#F9E1E0,#FEADB9,#BC85A3,#9799BA,#7175A2);
        }
